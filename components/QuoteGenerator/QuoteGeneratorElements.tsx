...
export const QuoteGeneratorCon = styled.div`
    ...
    border-radius: 15px;
    /* top + left + transform => to center a div within a div */
    top: 50%;
    left: 50%;
...
export const QuoteGeneratorTitle = styled.div`
    ...
    position: relative;
    /* media query => allows adjusted style for different devices*/
...
export const QuoteGeneratorModalCon = styled(Box)`
    ...
    border-radius: 10px;
    border: 1px solid rgba( 255,255,255,0.18 );
    /* Por default trae un borde blanco, aquí se lo quitamos */
    &:focus {
